...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <head>
        ...
        <link rel="stylesheet" href="{{ asset('site/css/corporativo.css') }}" type="text/css">
        <!-- Bootstrap CSS -->
          ...
          <div class="modal-dialog">
            ...
            <div class="modal-content">
              ...
              <div class="modal-footer">
                ...
                <a href="{{ url('construcao') }}"><button type="button" class="btn btn-primary">Gerar Arquivo PDF</button></a>
              </div>
