...
<!--    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/4.5.0/css/bootstrap.min.css" integrity="sha256-aAr2Zpq8MZ+YA/D6JtRD3xtrwpEz2IqOS+pWD/7XKIw=" crossorigin="anonymous" />-->
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/bootstrap.min.css')); ?>" integrity="sha256-aAr2Zpq8MZ+YA/D6JtRD3xtrwpEz2IqOS+pWD/7XKIw=" crossorigin="anonymous" />
    </head>
    ...
    <div id="caModal" class="modal" style="background-color: rgba(0, 0, 0, 0.3); opacity: 0.9;">   
        <div class="container">
            <div class="card" style="z-index:1060; top:65px;">
                ...
                <div class="card-body form-group">
                    ...
                    <div style='font-size: 10px;'>
                        <center>Prettus Klan - <?php echo e(formatDateAndTime( date('Y-m-d H:i:s') )); ?></center> 
                    </div>
                </div>
        </div>
    </div>    
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\desenv\computatrum\resources\views/auth/editor.blade.php ENDPATH**/ ?>