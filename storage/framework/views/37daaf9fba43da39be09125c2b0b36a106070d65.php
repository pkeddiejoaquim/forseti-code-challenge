...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    ...
    <head>
        ...
        <title>Computatrum.Ius - Construcao</title>

    </head>
    <body>
    <BR><BR><BR>
    <!-- Botão que irá abrir o modal -->
    <button type="button" class="btn btn-success btn-lg mt-2 ml-2" data-toggle="modal" data-target="#caModal">chamada Modal</button>

    <BR><BR><BR><BR><BR>
        <a href="javascript:history.back()"><img src='../imgs/sistema/remove1.png' alt='Fecha Janela' class="top-right links" align="right"/></a>
        <BR><BR>
        <a href="javascript:alert('em Construção !!!')"><center><img src='../imgs/sistema/trabalhando.gif'></center></a>
...
<?php /**PATH E:\xampp\htdocs\desenv\computatrum\resources\views/site/construcao.blade.php ENDPATH**/ ?>