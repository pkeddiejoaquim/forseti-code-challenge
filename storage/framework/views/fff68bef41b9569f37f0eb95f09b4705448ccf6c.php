...
<nav class='navbar'>
    <div class='menu'>
        ...
        <div id='nav-usuarios' class='nav-link' data-toggle='dropdown'>
            <h5>
                <a href='construcao'><i class='fas fa-address-card'></i>&nbsp;&nbsp;Forseti - Soluções</a>
            </h5>
        </div>
...
<nav class='navbar'>
    <div class='menu'>
        <div class='nav-link' data-toggle='dropdown'>
            <h5>
                <a href=''><i class='fas fa-sitemap'></i>&nbsp;&nbsp;Sistemas do Forseti</a>
            </h5>
        </div>
...
<?php /**PATH E:\xampp\htdocs\desenv\forseti-code-challenge\resources\views/auth/admin.blade.php ENDPATH**/ ?>