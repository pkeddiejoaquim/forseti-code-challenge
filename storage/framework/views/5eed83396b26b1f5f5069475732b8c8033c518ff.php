                ...
                <div class="col-md-6">
                    <div class="card" style="z-index:1060; top:100px;">
                        <div class="card-header" style='min-height: 45px !important; background-image: linear-gradient(to top, #0075be, #005a9c); color: rgb(255, 255, 255);'>
                            <?php echo e(__('Login Administrador')); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\server-www\htdocs\desenv\gis\resources\views/admin/userAdmin.blade.php ENDPATH**/ ?>